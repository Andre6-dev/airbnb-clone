package io.devandre.airbnbclone.user.application;
...
import io.devandre.airbnbclone.user.mapper.UserMapper;
import io.devandre.airbnbclone.user.repository.UserRepository;
...
public class UserService {
    ...
    public void syncWithAuth0(OAuth2User oAuth2User, boolean forceResync) {
